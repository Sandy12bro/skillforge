...
export default function DailyChallenge() {
  ...
  if (isCompleted) {
    return (
      <div className="bg-green-400 text-black px-6 py-6 border-2 border-black shadow-[4px_4px_0px_var(--shadow)] rounded-md mb-10 flex items-center justify-center gap-6 animate-in fade-in zoom-in duration-500">
  ...
  return (
    <div className="bg-green-400 border-2 border-black shadow-[4px_4px_0px_var(--shadow)] rounded-md p-6 relative overflow-hidden mb-10 group">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-4">
            <span className="bg-foreground text-background px-3 py-1 text-[10px] font-black uppercase tracking-widest border-2 border-background shadow-[2px_2px_0px_var(--shadow)]">🔥 DAILY HOT FIX</span>
